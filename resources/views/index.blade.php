...
<html lang="en">
	<!--begin::Head-->
	<head><base href="">
		<title>Nose Herbal Indo - User List</title>
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					...
					<div class="aside-logo flex-column-auto" id="kt_aside_logo" style="background-color: #ffffff; justify-content: center;">
						<!--begin::Logo-->
						<a href="/" data-navigo>
							<img alt="Logo" src="{{ asset('assets/media/logos/nose_logo.webp') }}" class="h-40px logo" />
						</a>
						<!--end::Logo-->
						<!--begin::Aside toggler-->
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
								<a href="../../demo1/dist/index.html" class="d-lg-none">
									<img alt="Logo" src="{{ asset('assets/media/logos/nose_logo.webp') }}" class="h-30px" />
								</a>
							</div>
							<!--end::Mobile logo-->
							<!--begin::Wrapper-->
									...
									<div class="d-flex align-items-stretch flex-shrink-0">
										...
										<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
											...
											<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
												<img src="{{ url('assets/media/avatars/default.jpg') }}" alt="user" />
											</div>
											<!--begin::Menu-->
												...
												<div class="menu-item px-3">
													<div class="menu-content d-flex align-items-center px-3">
														...
														<div class="symbol symbol-50px me-5">
															{{-- <img alt="Logo" src="dashboard/assets/media/avatars/default.jpg" /> --}}
                                                            <img alt="Logo" src="{{ url('assets/media/avatars/default.jpg') }}" />
														</div>
														<!--end::Avatar-->
														<!--begin::Username-->
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1" id="ttl-header">User List
									<!--begin::Separator-->
                                ...
                                <div id="kt_app_content" class="app-content flex-column-fluid">
                                    <div id="kt_app_content_container" class="app-container container-xxl pt-10">
                                        <div id="kt_post">
                                            ...
                                            <div class="row table_data" data-roleable="false" data-role="User-Read">
                                                <div class=" col-12" id="tableUserContainer">
                                                            ...
                                                            <div class="row mb-5">
                                                                <div class="col-12 col-xl d-flex align-items-center justify-content-between ">
                                                                    <div class=" d-flex align-items-center">
                                                                        ...
                                                                        <h3 class="mt-1 mb-5 ms-5">List User</h3>
                                                                    </div>
                                                                ...
                                                                <div class="col-12 col-xl-3 col-md-6 col-lg-6 mt-5 my-md-0">
                                                                    <button class="btn btn-primary w-100" data-roleable="false" data-role="adduser" onclick="onAdd()" id="toggleFormButton"><i class="las la-plus fs-2"></i> Tambah Data</button>
                                                                </div>
                                                            </div>
                                                            <div class="table-responsive border-2 border-top">
                                                                <table class="table table-striped table-row-bordered align-middle rounded tdFirstCenter" id="tableUser">
                                                                    <thead>
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="{{ url('/') }}" target="_blank" class="text-gray-800 text-hover-primary">Nose Herbal Indo</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
	    ...
	    <script src="https://cdn.jsdelivr.net/npm/@eonasdan/tempus-dominus@6.7.13/dist/js/tempus-dominus.min.js" crossorigin="anonymous"></script>
